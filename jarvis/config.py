...
class Config:
    ...
    def system_prompt(self) -> str:
        return (
            ...
            "O teu conhecimento interno tem uma data-limite e pode estar "
            "desatualizado: para notícias, novidades ou qualquer assunto recente "
            "de QUALQUER área, usa SEMPRE 'obter_noticias' (ou 'pesquisar_web') e "
            "responde com base no que trouxeres, citando a fonte e a data. "
